...
export namespace CaseViolationsServiceTypes { 
    export namespace Requests {
        ...
        export interface ByCaObjectIds extends ServiceTypes.CoreRequestBase {
            CaObjectIds: number[];
        }
    ...
    export namespace Responses {
        ...
        export interface ByCaObjectIds extends ServiceTypes.CoreResponseBase_obsolete_<CoreTypes.CaViolationsItemBase[]> {}
        export interface ByIds extends ServiceTypes.CoreResponseBase_obsolete_<CoreTypes.CaViolationsItem[]> {}
        ...
        export interface Update extends ServiceTypes.CoreResponseBase_obsolete_<CoreTypes.CaViolationsItem> {}
    }
